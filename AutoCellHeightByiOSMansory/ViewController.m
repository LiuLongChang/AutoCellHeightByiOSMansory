...
- (void)viewDidLoad {
    ...
    [self.tableView registerClass:[HomeViewCell class] forCellReuseIdentifier:homeIdentifier];
...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    HomeViewCell * cell = [tableView dequeueReusableCellWithIdentifier:homeIdentifier];
...
-(CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    CGFloat h = homeModel.cellHeight;
    return h;
}
